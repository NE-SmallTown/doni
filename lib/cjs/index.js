...
var DoniTableRootStoreContext = React__default["default"].createContext(null);
DoniTableRootStoreContext.displayName = 'DoniTableRootStoreContext';
function useModel() {
    var store = React.useContext(DoniTableRootStoreContext);
    if (store === null) {
...
var ColGroup = mobxReactLite.observer(function ColGroup(props) {
    var headSizes = useModel().headSizes;
    // console.log('ColGroup render')
    return (jsxRuntime.jsx("colgroup", { children: headSizes.map(function (_a, index) {
            var width = _a.width;
            return (jsxRuntime.jsx("col", { style: { width: width + 'px' } }, index));
        }) }, void 0));
});

var HeadUnit = mobxReactLite.observer(function HeadUnit(_a) {
    _a.maxLine; var className = _a.className, children = _a.children, restProps = __rest(_a, ["maxLine", "className", "children"]);
    return (jsxRuntime.jsx("div", __assign({ className: classNames([
            'doni-table-th-cell',
            className,
...
var HeadCell = mobxReactLite.observer(function HeadCell(props) {
    ...
    if (typeof childElement === 'object') {
        ...
        return (jsxRuntime.jsx("th", __assign({ className: className, style: style }, { children: childElement }), void 0));
    }
    return (jsxRuntime.jsx("th", __assign({ className: className, style: style }, { children: jsxRuntime.jsx(HeadUnit, { children: childElement }, void 0) }), void 0));
});

var HeadItem = mobxReactLite.observer(function HeadItem(props) {
    var column = props.column, index = props.index, rowKey = props.rowKey, scroll = props.scroll;
    // console.log('HeadItem render')
    return (jsxRuntime.jsx(HeadCell, { index: index, column: column, rowKey: rowKey, scroll: scroll }, index));
});

var BodyUnit = mobxReactLite.observer(function BodyUnit(_a) {
    _a.maxLine; var className = _a.className, children = _a.children, restProps = __rest(_a, ["maxLine", "className", "children"]);
    return (jsxRuntime.jsx("div", __assign({ className: classNames([
            'doni-table-td-cell',
            className,
...
var useForceUpdate = function () {
    var _a = React.useState({}); _a[0]; var set = _a[1];
...
var BodyCell = mobxReactLite.observer(function BodyCell(props) {
    ...
    if (typeof childElement === 'object') {
        ...
        return (jsxRuntime.jsx("td", __assign({ className: 'doni-table-td', style: style }, { children: childElement }), void 0));
    }
    return (jsxRuntime.jsx("td", __assign({ className: 'doni-table-td', style: style }, { children: jsxRuntime.jsx(BodyUnit, { children: childElement }, void 0) }), void 0));
});

var BodyItem = mobxReactLite.observer(function BodyItem(props) {
    ...
    //    辣鸡 mbox。。。
    return (jsxRuntime.jsx("tr", __assign({ className: 'doni-table-tr' }, { children: columns.map(function (column, index) { return (jsxRuntime.jsx(BodyCell, { index: index, record: record, column: column, rowKey: rowKey }, index)); }) }), void 0));
});
...
var DoniResizeObserver = function DoniResizeObserver(props) {
    ...
    var _a = React.useState(false), isFirstMeasured = _a[0], setIsFirstMeasured = _a[1];
    var helperDIVRef = React.useRef(null);
    var initialHelperDIVRef = React.useRef(null);
    React.useEffect(function () {
    ...
    if (!isFirstMeasured) {
        return (jsxRuntime.jsx("div", { className: 'resize-helper-div', ref: initialHelperDIVRef }, void 0));
    }
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx("div", { className: 'resize-helper-div', ref: helperDIVRef }, void 0), children && React__default["default"].Children.only(children)] }, void 0));
};

var DetectTableInfo = mobxReactLite.observer(function DetectTableInfo(props) {
    var columns = props.columns;
    var setHeadSizes = useModel().setHeadSizes;
    var handleOnSize = React.useCallback(function (info) {
    ...
    return (jsxRuntime.jsx(DoniResizeObserver, { onSize: handleOnSize }, void 0));
});

var DoniTablePagination = mobxReactLite.observer(function DoniTablePagination(props) {
    ...
    var handlePageChange = React.useCallback(function (page, pageSize) {
        setCurrentPage(page, pageSize);
    }, []);
    return (jsxRuntime.jsx("div", __assign({ className: 'doni-table-pagination' }, { children: jsxRuntime.jsx(antd.Pagination, __assign({ onChange: handlePageChange }, paginationProps), void 0) }), void 0));
});
...
var getSafeMobxValue = function (value) { return typeof value === 'object' ? mobxStateTree.getSnapshot(value) : value; };
var DoniTable = mobxReactLite.observer(function DoniTable(props) {
    ...
    var cacheScroll = React.useMemo(function () { return scroll; }, []);
    var cachePagination = React.useMemo(function () { return (__assign({ defaultPageSize: 10 }, pagination)); }, []);
    var tableProps = {
        tableId: tableId,
        rowKey: rowKey,
        columns: columns,
    ...
    var initDataRef = React.useRef(initData);
    React.useEffect(function () {
    ...
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsxs("div", __assign({ style: style, className: classNames([
                    'doni-table-wrap',
                    className,
                ]) }, { children: [jsxRuntime.jsx(DetectTableInfo, { columns: props.columns }, void 0), jsxRuntime.jsx(DoniTableInner, __assign({}, tableProps), void 0), loading && jsxRuntime.jsx(antd.Spin, { className: 'doni-table-loading-spin' }, void 0)] }), void 0), pagination !== false && jsxRuntime.jsx(DoniTablePagination, __assign({}, paginationProps), void 0)] }, void 0));
});
var createDoniTable = function (tableId, recordMobxType, rowKey) {
    var getListModel = function () {
        var _a;
        return mobxStateTree.types.array(mobxStateTree.types.compose(recordMobxType, mobxStateTree.types.model((_a = {},
            _a[NEED_FILTER] = mobxStateTree.types.optional(mobxStateTree.types.boolean, true),
            _a))));
    };
    var DoniTableRootModel = mobxStateTree.types
        .model({
        ...
        listMode: mobxStateTree.types.enumeration('ListMode', ['scroll', 'pagination']),
        displayList: getListModel(),
        list: getListModel(),
        currentPage: mobxStateTree.types.number,
        pageSize: mobxStateTree.types.number,
        headSizes: mobxStateTree.types.array(mobxStateTree.types.model({
            width: mobxStateTree.types.number,
        })),
    })
        ...
        var actions = {
            ...
            setHeadSizes: function (headSizes) {
                self.headSizes = mobxStateTree.cast(headSizes);
            },
            getListSnapshot: function () {
                return mobxStateTree.getSnapshot(self.list);
            },
        };
    ...
    return function CreateDoniTable(props) {
        return (jsxRuntime.jsx(DoniTableRootStoreContext.Provider, __assign({ value: initialDoniTableRootStoreState }, { children: jsxRuntime.jsx(DoniTable, __assign({}, props, { rowKey: rowKey, tableId: tableId }), void 0) }), void 0));
    };
};
var DoniTableInner = mobxReactLite.observer(function DoniTableInner(props) {
    ...
    return (jsxRuntime.jsxs("table", __assign({ className: 'doni-table', style: style }, { children: [jsxRuntime.jsx(ColGroup, { columns: columns, scroll: scroll }, void 0), jsxRuntime.jsx("thead", { children: jsxRuntime.jsx("tr", { children: columns.map(function (column, index) { return (jsxRuntime.jsx(HeadItem, { index: index, rowKey: rowKey, column: column, scroll: scroll }, index)); }) }, void 0) }, void 0), jsxRuntime.jsx("tbody", { children: list.map(function (record, index) { return (jsxRuntime.jsx(BodyItem, { index: index, rowKey: rowKey, record: record, columns: columns }, index)); }) }, void 0)] }), void 0));
});
...
var CopyToClipboard = function (_a) {
    ...
    var _c = React.useState(false), hasCopy = _c[0], setHasCopy = _c[1];
    var handleOnCopy = React.useCallback(function () {
        setHasCopy(true);
        setTimeout(function () {
            setHasCopy(false);
        }, resetDelay);
    }, []);
    return (jsxRuntime.jsx(lib.CopyToClipboard, __assign({ text: text, onCopy: handleOnCopy }, restProps, { children: hasCopy
            ? jsxRuntime.jsx(icons.CheckOutlined, { style: { color: '#52c41a' } }, void 0)
            : jsxRuntime.jsx(icons.CopyOutlined, { style: { color: '#1890ff' } }, void 0) }), void 0));
};
...
var FilterDropdown = function (props) {
    ...
    var _c = React.useState(false), dropdownVisible = _c[0], setDropdownVisible = _c[1];
    var _d = React.useState([]), selectedKeys = _d[0], setSelectedKeys = _d[1];
    var handleMenuSelect = React.useCallback(function (_a) {
        var selectedKeys = _a.selectedKeys;
        setSelectedKeys(selectedKeys);
    }, []);
    var handleDropdownVisibleChange = React.useCallback(function (visible) {
        setDropdownVisible(visible);
    }, []);
    var handleClickReset = React.useCallback(function () {
        setSelectedKeys([]);
    }, []);
    var handleClickSubmit = React.useCallback(function () {
    ...
    return (jsxRuntime.jsx("div", __assign({ className: classNames([
            ...
            className,
        ]) }, restProps, { children: jsxRuntime.jsx(antd.Dropdown, __assign({ overlay: (jsxRuntime.jsxs("div", __assign({ className: 'doni-filter-dropdown-overlay' }, { children: [jsxRuntime.jsx(antd.Menu, __assign({ multiple: multiple, onSelect: handleMenuSelect, onDeselect: handleMenuSelect, selectedKeys: selectedKeys }, restMenuProps, { children: data.map(function (_a, index) {
                            var text = _a.text, value = _a.value;
                            var key = String(value || index);
                            return (jsxRuntime.jsxs(antd.Menu.Item, __assign({ className: 'filter-item' }, { children: [jsxRuntime.jsx(antd.Checkbox, { checked: selectedKeys.includes(key) }, void 0), jsxRuntime.jsx("span", __assign({ className: 'filter-item-text' }, { children: text }), void 0)] }), key));
                        }) }), void 0), jsxRuntime.jsxs("div", __assign({ className: 'actions' }, { children: [jsxRuntime.jsx(antd.Button, __assign({ type: 'link', size: 'small', disabled: selectedKeys.length === 0, onClick: handleClickReset }, { children: "Reset" }), void 0), jsxRuntime.jsx(antd.Button, __assign({ type: 'primary', size: 'small', onClick: handleClickSubmit }, { children: "Submit" }), void 0)] }), void 0)] }), void 0)), trigger: ['click'], visible: dropdownVisible, onVisibleChange: handleDropdownVisibleChange, placement: 'bottomRight' }, dropdownProps, { children: jsxRuntime.jsx("span", __assign({ className: 'icon', onClick: function (e) { return e.stopPropagation(); } }, { children: jsxRuntime.jsx(icons.FilterFilled, {}, void 0) }), void 0) }), void 0) }), void 0));
};

var ModalButton = mobxReactLite.observer(function ModalButton(props) {
    var button = props.button, children = props.children, className = props.className, modal = props.modal, modalProps = props.modalProps;
    var _a = React.useState(false), confirmLoading = _a[0], setConfirmLoading = _a[1];
    var handleClickButton = React.useCallback(function () {
        modal.openModal();
    }, []);
    var handleClickModalOk = React.useCallback(function () {
        setConfirmLoading(true);
    }, []);
    var handleClickModalCancel = React.useCallback(function () {
        modal.closeModal();
    }, []);
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx(antd.Button, __assign({ type: 'primary', className: className, onClick: handleClickButton }, { children: button }), void 0), jsxRuntime.jsx(antd.Modal, __assign({ visible: modal.visible, width: '50%', style: {
                    top: 150,
...
exports.BodyCell = BodyUnit;
exports.CopyToClipboard = CopyToClipboard;
exports.DoniTableActionMobxType = DoniTableActionMobxType;
exports.Ellipsis = Ellipsis;
exports.FilterDropdown = FilterDropdown;
exports.HeadCell = HeadUnit;
exports.ModalButton = ModalButton;
exports.Table = ExportDoniTable;
